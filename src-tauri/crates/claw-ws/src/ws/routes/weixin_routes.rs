...
fn get_weixin_config(
    registry: &claw_channel::ChannelRegistry,
) -> Option<claw_channel::plugins::weixin::ilink_api::ILinkConfig> {
    ...
    let account = accounts
        .iter()
        .find(|a| a.channel_id.as_str() == "weixin")?;
