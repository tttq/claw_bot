...
when_to_use: 微信相关操作，如发送消息、搜索联系人、打开聊天窗口等
allowed-tools: ["ExecuteAutomation", "CaptureScreen", "MouseClick", "MouseDoubleClick", "KeyboardType", "KeyboardPress", "LaunchApplication"]
argument_hint: <微信操作指令，如 "给张三发消息：你好">
user_invocable: true
version: 1.0.0
shortcuts:
  搜索: Ctrl+F
