...
fn key_down_windows(key: &str) -> Result<()> {
    ...
    let vk = match key.to_lowercase().as_str() {
        "a" => VK_A.0, "b" => VK_B.0, "c" => VK_C.0, "d" => VK_D.0,
        "e" => VK_E.0, "f" => VK_F.0, "g" => VK_G.0, "h" => VK_H.0,
        "i" => VK_I.0, "j" => VK_J.0, "k" => VK_K.0, "l" => VK_L.0,
        "m" => VK_M.0, "n" => VK_N.0, "o" => VK_O.0, "p" => VK_P.0,
        "q" => VK_Q.0, "r" => VK_R.0, "s" => VK_S.0, "t" => VK_T.0,
        "u" => VK_U.0, "v" => VK_V.0, "w" => VK_W.0, "x" => VK_X.0,
        "y" => VK_Y.0, "z" => VK_Z.0,
        "0" => VK_0.0, "1" => VK_1.0, "2" => VK_2.0, "3" => VK_3.0,
        "4" => VK_4.0, "5" => VK_5.0, "6" => VK_6.0, "7" => VK_7.0,
        "8" => VK_8.0, "9" => VK_9.0,
        "space" | " " => VK_SPACE.0,
        ...
        _ => {
            ...
            if key.len() == 1 {
                let ch = key.chars().next()
                    .ok_or_else(|| AutomaticallyError::Input(format!("Unsupported key: {}", key)))?;
                match ch {
                    'a'..='z' => VK_A.0 + (ch as u16 - 'a' as u16),
                    'A'..='Z' => VK_A.0 + (ch as u16 - 'A' as u16),
                    '0'..='9' => VK_0.0 + (ch as u16 - '0' as u16),
                    ' ' => VK_SPACE.0,
                    _ => return Err(AutomaticallyError::Input(format!("Unsupported key: {}", key))),
                }
            } else {
                return Err(AutomaticallyError::Input(format!("Unsupported key: {}", key)));
            }
        }
    };
...
fn key_down_linux(key: &str) -> Result<()> {
    ...
    let keysym = match key.to_lowercase().as_str() {
        "a" => x11::keysym::XK_a, "b" => x11::keysym::XK_b, "c" => x11::keysym::XK_c,
        "d" => x11::keysym::XK_d, "e" => x11::keysym::XK_e, "f" => x11::keysym::XK_f,
        "g" => x11::keysym::XK_g, "h" => x11::keysym::XK_h, "i" => x11::keysym::XK_i,
        "j" => x11::keysym::XK_j, "k" => x11::keysym::XK_k, "l" => x11::keysym::XK_l,
        "m" => x11::keysym::XK_m, "n" => x11::keysym::XK_n, "o" => x11::keysym::XK_o,
        "p" => x11::keysym::XK_p, "q" => x11::keysym::XK_q, "r" => x11::keysym::XK_r,
        "s" => x11::keysym::XK_s, "t" => x11::keysym::XK_t, "u" => x11::keysym::XK_u,
        "v" => x11::keysym::XK_v, "w" => x11::keysym::XK_w, "x" => x11::keysym::XK_x,
        "y" => x11::keysym::XK_y, "z" => x11::keysym::XK_z,
        "0" => x11::keysym::XK_0, "1" => x11::keysym::XK_1, "2" => x11::keysym::XK_2,
        "3" => x11::keysym::XK_3, "4" => x11::keysym::XK_4, "5" => x11::keysym::XK_5,
        "6" => x11::keysym::XK_6, "7" => x11::keysym::XK_7, "8" => x11::keysym::XK_8,
        "9" => x11::keysym::XK_9,
        ...
        "f1" => x11::keysym::XK_F1, "f2" => x11::keysym::XK_F2, "f3" => x11::keysym::XK_F3,
        "f4" => x11::keysym::XK_F4, "f5" => x11::keysym::XK_F5, "f6" => x11::keysym::XK_F6,
        "f7" => x11::keysym::XK_F7, "f8" => x11::keysym::XK_F8, "f9" => x11::keysym::XK_F9,
        "f10" => x11::keysym::XK_F10, "f11" => x11::keysym::XK_F11, "f12" => x11::keysym::XK_F12,
        _ => {
            if key.len() == 1 {
                let ch = key.chars().next()
                    .ok_or_else(|| AutomaticallyError::Input(format!("Unsupported key: {}", key)))?;
...
fn key_down_macos(key: &str) -> Result<()> {
    ...
    let keycode = match key.to_lowercase().as_str() {
        ...
        "return" | "enter" => 36, "l" => 37, "j" => 38, "'" => 39, "k" => 40, ";" => 41,
        "\\" => 42, "," => 43, "/" => 44, "n" => 45, "m" => 46, "." => 47,
        "tab" => 48, "space" | " " => 49, "`" => 50, "delete" | "backspace" | "back" => 51,
        "escape" | "esc" => 53,
        "command" | "cmd" | "win" => 55, "shift" => 56, "caps" => 57, "option" | "alt" => 58,
        "control" | "ctrl" => 59,
